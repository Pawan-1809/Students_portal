...
def student_home(request):
    # Fetch the student object using the logged-in user's ID
    ...
    # Fetch the course and subject information
    ...
    # Loop through subjects to gather attendance data
    subject_data = Subjects.objects.filter(course_id=student_obj.course_id)
    
    for subject in subject_data:
        # Get attendance for the specific subject
        attendance = Attendance.objects.filter(subject_id=subject.id)
        
        # Count present and absent attendance for each subject
